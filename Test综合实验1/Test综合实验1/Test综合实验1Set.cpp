...
// Test综合实验1Set.cpp : CTest综合实验1Set 类的实现
//
...
// 代码生成在 2020年5月18日, 10:38

IMPLEMENT_DYNAMIC(CTest综合实验1Set, CRecordset)

CTest综合实验1Set::CTest综合实验1Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	m_1 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString CTest综合实验1Set::GetDefaultConnect()
{
...
CString CTest综合实验1Set::GetDefaultSQL()
{
	return _T("[学生信息]");
}

void CTest综合实验1Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void CTest综合实验1Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void CTest综合实验1Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
