...
// week13综合实验2Set.cpp : Cweek13综合实验2Set 类的实现
//
...
// 代码生成在 2020年5月19日, 21:42

IMPLEMENT_DYNAMIC(Cweek13综合实验2Set, CRecordset)

Cweek13综合实验2Set::Cweek13综合实验2Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	m_1 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString Cweek13综合实验2Set::GetDefaultConnect()
{
...
CString Cweek13综合实验2Set::GetDefaultSQL()
{
	return _T("[学生信息]");
}

void Cweek13综合实验2Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void Cweek13综合实验2Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void Cweek13综合实验2Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
